...
class AwesomeAPITest(MethodResource, Resource):
    @doc(description='My First GET Awesome APItest.', tags=['AwesomeTest'])
    @marshal_with(AwesomeResponseSchema)  # marshalling
    def get(self):
        '''
        Get method represents a GET API method
...
api.add_resource(AwesomeAPITest, '/awesomeTest')
docs.register(AwesomeAPI)
docs.register(AwesomeAPITest)
